...
private:
    ...
    void display_header() {
        ...
        std::cout << "MinimalRedis Enhanced TUI Client v2.0" << std::endl;
...
public:
    ...
    void run() {
        std::cout << "[TARGET] Welcome to MinimalRedis Enhanced TUI Client!" << std::endl;
        ...
        std::cout << "\n[BYE] Thank you for using MinimalRedis Enhanced TUI Client!" << std::endl;
        std::cout << "Have a great day! [ROCKET]" << std::endl;
    }
};

// Implementation of RedisClient methods
